...
// Schemas
export const ExperienceSearchBaseSchema = z.object({
    // Text searches
...
export const ExperienceSearchSchema = ExperienceSearchBaseSchema.refine(
    (data) => {
...
export const ExperienceSearchRequestSchema = z.object({
    ...
    ...ExperienceSearchBaseSchema.shape,
});
...
export type ExperienceSearchRequest = z.infer<
    typeof ExperienceSearchRequestSchema
>;
